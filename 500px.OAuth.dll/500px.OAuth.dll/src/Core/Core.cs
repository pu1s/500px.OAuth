...
namespace ags.Core
{
    public class Core
    {
        ...
        /// </returns>
        public static string Sign(HttpMethods httpMethod, string requestUrl, List<RequestParameter> requestParameters,
            ...
            OAuthToken token)
        {
            ...
            requestParameters.Add(new RequestParameter(OAuthParam.Signature, NormalizeParameter(sigmature)));
            // формируем строку
